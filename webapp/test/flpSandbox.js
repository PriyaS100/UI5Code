		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 ",
									"targetURL": "#zpriyasapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zpriyasapui5-display": {
								"semanticObject": "zpriyasapui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpriyasapui5",
									"url": sap.ui.require.toUrl("zpriyasapui5")
								}
							}
						}
					}
